...
// Case studies and showcase products
export const products: Product[] = [
  {
    ...
    caseStudy: {
      ...
      testimonial: {
        quote:
          'Watermelon Studio took us from a rough idea to a product hospitals actually use. They thought like product owners, not contractors, and shipped faster than any team we have worked with.',
        name: 'Client Name',
        role: 'Founder, Medesk',
      },
    },
