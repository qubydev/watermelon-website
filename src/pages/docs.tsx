...
export default function Docs() {
  return (
    <TextPage
      title="API docs"
      documentTitle="API docs | Watermelon Studio"
      intro="A small public read-only API describing Watermelon Studio's case studies, so agents and scripts can read our work without scraping the pages."
    >
...
curl "${SITE_URL}/api/v1/products?type=Dashboard"`}</Code>
      ...
      <Section heading="GET /api/v1/studio">
        <p>Returns studio-level facts: what Watermelon Studio does, the services offered, contact addresses and the canonical URLs of the machine-readable files.</p>
