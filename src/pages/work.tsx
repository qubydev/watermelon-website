...
export default function Work() {
  ...
  return (
    <div className="work-page-grid relative flex min-h-screen flex-col overflow-x-hidden bg-background text-foreground">
      ...
      <main className="relative z-10 w-full flex-1 px-6 py-8 pb-12 sm:px-10 sm:py-10 sm:pb-16 lg:px-12">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {visible.map((product) => (
              <div
                key={product.slug}
                className="product-noise group relative flex flex-col justify-between overflow-hidden border border-border/80 bg-card"
              >
