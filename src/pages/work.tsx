...
export default function Work() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0)
    document.title = 'Work | Watermelon Studio'
  }, [])
    ...
    <SplitLayout
      ...
      panel={
        <>
          ...
          <h1 className="text-2xl leading-8 font-bold tracking-normal text-balance text-foreground">
            Standout digital products and brands
          </h1>
          ...
          <div className="mt-6 border-t border-border/80 pt-4">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3">
              <a
                ...
                href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent("Build something with Watermelon Studio")}`}
              >
                Book a call
              </a>
              <a
      ...
      showcase={
        <div className="grid gap-4">
          {visible.map((product) => (
            <div
              className="product-noise group relative block overflow-hidden rounded-none border border-border/80 bg-card"
              key={product.slug}
            >
