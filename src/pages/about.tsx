...
export default function About() {
  return (
    <TextPage
      title="About Watermelon Studio"
      documentTitle="About | Watermelon Studio"
      intro="Watermelon Studio is a digital product and branding studio. We partner with ambitious founders to design and build high-impact websites, apps, and brand systems."
    >
      <Section heading="What we do">
        <p>
          Watermelon Studio designs and builds software products end to end. That covers product strategy, interface design,
